...
export default function Home() {
    return (
      <main className='overflow-hidden lg:fixed top-0 w-full h-full lg:flex lg:justify-center lg:p-6 bg-gradient-to-tr from-sky-200 to-blue-100 animated-background'>
        <div className="bg-white shadow-lg border-2 border-black w-screen overflow-y-scroll snap-y snap-mandatory scroll-smooth no-scrollbar">
          <div id="grid_spacer_home_t" className="h-[121px] w-full relative">
              <Grid />
          </div>

          <div id="hero_container" className="p-2 flex flex-col justify-center snap-always snap-center">
            ...
            <div id="hero_banner" className="flex flex-col lg:flex-row w-full justify-center items-center mt-3 pb-10 popin">
              ...
              <div id="cover_text" className="w-full lg:w-1/2 text-center flex flex-col justify-center items-center m-5">
                <h3 className="text-4xl p-1">Hi, I&apos;m <span className="text-4xl font-bold inline-block relative w-[max-content]
          ...
          <div id="grid_spacer_home_b" className="h-[120px] w-full relative flex justify-center">
              <Grid />
              <button><a href="#grid_spacer_skills_t" className="scroll-smooth absolute z-50 bg-black text-white p-2 rounded-full px-3 animate-pulse">&#x2193;</a></button>
          </div>
          <div id="grid_spacer_skills_t" className="h-[121px] w-full relative">
              <Grid />
          </div>
          ...
          <div id="skills_container" className="flex flex-col text-center items-center py-[5rem] w-full bg-[#f2f2f2]">
            ...
            <div id="skills" className="w-full flex flex-col lg:flex-row justify-center items-center *:mx-5 snap-always snap-center">
          ...
          <div id="grid_spacer_skills_b" className="h-[121px] w-full relative">
              <Grid />
          </div>

          <div id="hobby_container" className="flex flex-col text-center items-center m-[5rem]">
            <h3 className="text-4xl p-1 font-bold">I also love to pursue creative endevors</h3>
            
            <div className="lg:w-[90%] flex flex-col lg:flex-row my-10 lg:my-0 justify-around items-center snap-always snap-center lg:h-[500px]">
              <div id="hobby_text" className="text-left ml-auto">
                <p className="leading-loose text-left">
                  I&apos;ve been involved in musical theatre for over a decade,
                ...
                <p className="leading-loose text-left">
                  <br/>
                  I make writeups documenting and reflecting on my projects
              ...
              <div className="">
                <div id="hobby_img" className="flex lg:block lg:w-2/5 lg:mt-10 p-10 relative z-20">
                  ...
                  <div id="springawakening" className="m-2 w-[211px] inline-block relative lg:bottom-[7rem] lg:left-[5rem] after:absolute after:left-10 after:top-9 after:border-2 after:border-slate-700 after:w-full after:h-full after:-z-10">
            ...
            <h3 className="text-3xl items-center justify-center m-1 w-full">Read about my problem solving process
